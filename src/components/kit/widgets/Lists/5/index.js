    ...
    <div>
      <ul className="list-unstyled">
        <li className={style.item}>
          <Link to="/public/questions/all-questions?tag=paynment" className={style.itemLink}>
        ...
        <li className={style.item}>
          <Link to="/public/questions/all-questions?tag=paynmen2t" className={style.itemLink}>
            <div className={style.itemPic}>
